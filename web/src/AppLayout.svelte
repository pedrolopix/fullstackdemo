<script lang="ts">
  import {Button, Col, Divider, Drawer, Icon, Layout, Portal, Row, Swap, Toggle} from 'stwui';
...
<svelte:head>
  ...
  <!--  &lt;!&ndash; TODO:  figure out canonical rel &ndash;&gt;-->
  <!--  &lt;!&ndash; <link rel="canonical" href="https://madewithsvelte.com/ui-library"> &ndash;&gt;-->
  <!--  <meta name="og:title" content={$page.data.title} />-->
  <!--  <meta property="og:description" content={$page.data.description} />-->
  <!--  &lt;!&ndash; TODO: add url to all page load functions &ndash;&gt;-->
  <!--  &lt;!&ndash; <meta property="og:url" content={$page.data.url}> &ndash;&gt;-->
