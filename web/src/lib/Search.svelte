<script lang="ts">
  import {format_list_numbered, function_variant, lightning_bolt_circle, magnify, toggle_switch} from './icons';
  import {Button, Empty, Icon, Modal, Portal} from "stwui";
  import { scale } from 'svelte/transition';
  import {info} from "stwui/icons";
      ...
      >
        ...
        {:else}
          <Empty>
            ...
            <Empty.Description slot="description">No results found for this search. Please try again.</Empty.Description>
          </Empty>
        {/if}
      </Modal.Content>
    </Modal>
